  ...
  return (
    <div className="here relative">
      ...
      <div className="absolute top-24 right-10 lg:top-10 lg:right-36 w-5/6 md:w-4/6 lg:w-3/6 flex flex-col gap-4">
        <h1 className="text-zinc-900">Hi!</h1>
        <div>
        ...
        <div className="flex flex-wrap gap-x-10 gap-y-3">
          ...
          <SiPolywork className="icon"/>
            <a href="https://www.polywork.com/maryojo" target="_blank" rel="noreferrer">My recent activities</a>
          </div>
          <div className="flex flex-row items-center gap-2">
          <CiLinkedin className="icon"/>
            <a href="#" target="_blank" rel="noreferrer">My LinkedIn profile</a>
          </div>
          <div className="flex flex-row items-center gap-2">
          <SlSocialGithub className="icon"/>
            <a href="#" target="_blank" rel="noreferrer">My coding activities</a>
          </div>
          <div className="flex flex-row items-center gap-2">
          <SlSocialBehance className="icon"/>
            <a href="#" target="_blank" rel="noreferrer">My design </a>
          </div>
          <div className="flex flex-row items-center gap-2">
          <TbMailbox className="icon"/>
          <p>Send me a mail on <a href="#" target="_blank" rel="noreferrer">hi@maryojo.me</a></p>
          </div>
        </div>
      </div>
    </div>
